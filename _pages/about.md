...
- **研究背景：**
  ...
  3. 面对全新形式的线上课堂MAIC，既往关于MOOC的研究无法直接照搬到新系统上，因此，如何在新的环境下进一步解决[学生容易半途而废，无法坚持完成课程学习]的线上网课顽疾是一个值得十分指得深入研究的问题。
- **我们的方法：**
  提供了一套全面且系统的解决方案：
...
- **项目成果：**
  * 经过同[[面壁智能]](https://modelbest.cn/)的协作，该功能已于清华[[MAIC]](https://mp.weixin.qq.com/s/CNqiPKFaOfwJGLY5O2dKWw)平台上线，并在AB test中展现了其显著性能}
  * 相关论文已完成，并已投稿于 **CIKM 2025**（共同第一作者）；相关专利已完成申请（第一发明人）。
